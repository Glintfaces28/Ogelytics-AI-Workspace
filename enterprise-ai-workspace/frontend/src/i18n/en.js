const en = {
  ...
  chat_download_answer: 'Download answer',
  chat_history_empty: 'Your chat history will appear here after your first conversation.',
  chat_search_all: 'Search all',
  chat_error_retry: 'Sorry, something went wrong. Please try again.',
  chat_export_chat: 'Export chat',
  chat_docs_label: 'Documents',
  chat_loading_docs: 'Loading documents…',
  chat_today: 'Today',
  chat_yesterday: 'Yesterday',
  chat_days_ago: (n) => `${n} days ago`,

  // Teams
  teams_title: 'Teams',
  teams_subtitle: 'Manage workspace groups and member access.',
  teams_create: 'Create Team',
  teams_no_teams: 'No teams yet',
  teams_no_teams_sub: 'Create a team to get started.',
  ...
  teams_desc_label: 'Description',
  teams_create_btn: 'Create',
  teams_select: 'Select a team',
  teams_delete_btn: 'Delete',
  teams_member_email: 'Member email',
  teams_role_label: 'Role',
  teams_role_member: 'Member',
  teams_role_admin: 'Admin',
  teams_role_owner: 'owner',
  teams_add_btn: 'Add',
  teams_remove_title: 'Remove member',
  teams_member_count: (n) => `${n} ${n === 1 ? 'member' : 'members'}`,
